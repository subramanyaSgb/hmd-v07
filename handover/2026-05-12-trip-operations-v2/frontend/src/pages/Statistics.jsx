...
const Statistics = () => {
    ...
    // Default tab — user requested V2 land first across all 3 V2-redesign
    // pages (Statistics / Live Tracking / Trip Management) on 2026-05-12.
    // The Performance and Deviation tabs are still one click away.
