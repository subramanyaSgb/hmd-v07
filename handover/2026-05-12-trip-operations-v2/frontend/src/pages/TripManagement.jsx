...
import JswTripOperations from '../components/JswTripOperations/JswTripOperations'
...
const TripManagement = () => {
    ...
    // Default tab — flipped to 'jsw' on 2026-05-12 so users land on the new
    // Trip Operations V2 design (4-sub-tab board). Old default was 'overview';
    // it's still one click away and unchanged.
    const [activeTab, setActiveTab] = useState('jsw')
    ...
    return (
        <div className="strategic-command-center animate-in fade-in duration-700" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
            <main className="main-content-workspace" style={{ flex: 1, padding: '24px', overflow: 'hidden', display: 'flex', flexDirection: 'column', background: 'hsl(var(--main-bg))', minHeight: 0 }}>
                ...
                {/* JSW tab content swapped 2026-05-12 — the legacy JswTripsTab
                    table is still in the tree (`components/JswTripsTab.jsx`) as
                    a fallback; just not mounted from the UI. The new component
                    is the 4-sub-tab Trip Operations V2 board (Active /
                    Exceptions / Completed today / Timeline). */}
                {activeTab === 'jsw' && <JswTripOperations />}
            </main>
