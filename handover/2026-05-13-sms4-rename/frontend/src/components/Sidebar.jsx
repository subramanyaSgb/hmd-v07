...
import { LayoutDashboard, Settings as SettingsIcon, ClipboardList, Truck, Activity, BarChart2, Container, FileText, Shield, Factory, History, Scale, Gauge } from 'lucide-react'
...
const Sidebar = () => {
    ...
    const adminMenuItems = [
        ...
        // Weighbridge Audit — inserted 2026-05-13 at position 4 (per user
        // request to keep it directly below Trip Management).
        { path: '/weighbridge-audit', label: 'Weighbridge Audit', icon: <Scale size={20} /> },
        // SMS Performance — inserted 2026-05-13 at slot 5 (HTS analytics Tier 1).
        // Sits below Weighbridge Audit; both pages aggregate HTS+WBATNGL data,
        // so users naturally browse them together.
        { path: '/sms-performance', label: 'SMS-4 Performance', icon: <Gauge size={20} /> },
