...
const HeatsTable = ({ tick, range, sms, onRowClick }) => {
                ...
                <table className="smsperf-table">
                    ...
                    <tbody>
                        ...
                        {heats.map(h => (
                            <tr
                                key={h.heat_no}
                                className={`smsperf-row-clickable ${h.below_target ? 'smsperf-row-warn' : ''}`}
                                onClick={() => onRowClick && onRowClick(h.heat_no)}
