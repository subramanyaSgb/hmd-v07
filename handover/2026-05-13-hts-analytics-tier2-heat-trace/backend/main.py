...
from .routes import statistics, deviation_analytics, performance_analytics, v2_dashboard, tracking_v2, weighbridge_audit, sms_performance, heat_trace
...
app.include_router(sms_performance.router)                               # SMS Performance (HTS analytics Tier 1)
app.include_router(heat_trace.router)                                    # Heat trace BF→SMS→caster (HTS analytics Tier 2 #1)
