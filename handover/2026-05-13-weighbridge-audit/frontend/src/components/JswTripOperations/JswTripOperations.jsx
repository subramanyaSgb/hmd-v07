...
const JswTripOperations = () => {
    ...
    // Source filter default = 'All' (relabelled 2026-05-13 from 'All BFs' to
    // 'All' since the list now includes Corex 1 / Corex 2 in addition to
    // the 3 active BFs). 'All' still maps to no source_lab filter on the
    // backend — see ActiveTripBoard.js for the mapping.
    const [filters, setFilters] = useState({ shift: 'A', source: 'All', destination: 'All' });
