...
const WeighbridgeAudit = lazy(() => import('./pages/WeighbridgeAudit'))
const SMSPerformance = lazy(() => import('./pages/SMSPerformance'))
...
export const ROUTE_CONFIG = {
  ...
  '/weighbridge-audit': { title: 'Weighbridge Audit' },
  '/sms-performance': { title: 'SMS-4 Performance' },
...
function AppRoutes() {
  ...
  return (
    <Routes>
      <Route path="/" element={<PageWrapper><LiveTracking /></PageWrapper>} />
      ...
      {isAdminOrTRS && (
        <>
          ...
          <Route path="/weighbridge-audit" element={<PageWrapper><WeighbridgeAudit /></PageWrapper>} />
          <Route path="/sms-performance" element={<PageWrapper><SMSPerformance /></PageWrapper>} />
        </>
      )}
      {isPPC && (
        <>
