...
const Statistics = () => {
    ...
    // 2026-05-15 — VERSION 2 tab removed per user direction (trial feature, not
    // part of V07 baseline). Default reverts to 'performance' (AdminStatistics).
    // VERSION 2 toggle still lives on the Live Tracking page only.
